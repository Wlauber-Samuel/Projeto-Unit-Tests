...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se a função retorna undefined, caso o parâmetro passado não seja um número', () => {
    expect((circle['1, a, 2'])).toBeUndefined();
  });

  it('Verifica se a função cicle retorna um objeto', () => {
  ...
  const values = circle(3);
  expect(values.radius).toEqual(3);
  expect(values.area).toBeCloseTo(28.26);
  expect(values.circumference).toEqual(18.84)
  });
